                        ...
                        <table class="w-full text-left text-sm text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr v-for="activity in activities" :key="activity.id" class="border-b border-gray-700 bg-[#1a2c4e] hover:bg-[#243b61] transition-colors">
                                    ...
                                    <td class="px-6 py-4 font-medium text-white">{{ activity.title }} <span v-if="activity.is_manual" class="ml-2 text-[10px] text-gray-500 italic uppercase bg-gray-800 px-1 rounded">Manual</span></td>
                                    ...
                                    <td class="px-6 py-4">{{ activity.submitted_at ? new Date(activity.submitted_at).toLocaleDateString('en-GB') : '-' }}</td>
