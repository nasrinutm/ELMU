        ...
        <div class="p-6 bg-[#002B5C] min-h-screen text-white">
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-bold text-[#FFD700]">Edit Quiz</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <Card class="text-[#002B5C] bg-white">
                        ...
                        <CardContent class="grid gap-5">
                            <div class="grid gap-2">
                                ...
                                <Input v-model="form.title" required class="bg-white text-black border-gray-400 focus:border-[#002B5C] font-medium" />
                            </div>
                            <div class="grid gap-2">
                                <Label class="text-[#002B5C] font-bold">Description</Label>
                                <Textarea v-model="form.description" class="bg-white text-black border-gray-400 focus:border-[#002B5C] font-medium" />
                            </div>
                        ...
                        <Card class="border-l-4 border-l-[#FFD700] text-[#002B5C] bg-white">
                            ...
                            <CardContent class="grid gap-5">
                                <div class="grid gap-2">
                                    ...
                                    <Input v-model="question.text" placeholder="Question text" required class="bg-white text-black border-gray-400 focus:border-[#002B5C] font-bold text-md" />
                                </div>
                                
                                <div class="space-y-3 pl-4 border-l-4 border-gray-200 py-2">
                                    <Label class="text-sm uppercase text-[#002B5C] font-black tracking-wider">Answers (Click circle to mark correct)</Label>
                                    <div v-for="(option, oIndex) in question.options" :key="oIndex" class="flex items-center gap-2">
                                        ...
                                        <Input v-model="option.text" class="flex-1 bg-white text-black border-gray-400 focus:border-[#002B5C] font-medium" required />
                                ...
                                <div class="grid gap-2 mt-2">
                                    <Label class="text-[#002B5C] font-bold">Explanation</Label>
                                    <Textarea v-model="question.explanation" rows="2" class="bg-white text-black border-gray-400 focus:border-[#002B5C] font-medium" />
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <Button type="button" variant="outline" class="w-full border-dashed border-2 py-8 text-[#FFD700] border-[#FFD700] hover:bg-[#FFD700]/10 font-bold text-lg" @click="addQuestion">
                        <Plus class="mr-2 h-6 w-6" /> Add Question
                    </Button>
